...
export const actsData: ActData[] = [
  {
    ...
    blocks: [
      {
        id: "la-diferencia-entre-vivir-y-sentir",
  ...
  },
  {
    ...
    blocks: [
      {
        id: "el-sufrimiento-como-medida-justa",
  ...
  },
  {
    ...
    blocks: [
      {
        id: "la-ineficiencia-termodinamica",
      ...
      },
      {
        ...
        analogy: { text: "Si una ciudad reservara el 80% de sus calles para mover coches vacíos, sería un escándalo urbanístico. Esto es lo mismo, pero con selvas." },
    ...
    blocks: [
      {
        ...
        analogy: { text: "Es como cuando la ley dejó de considerar 'propiedad' a ciertos humanos: el cambio de etiqueta legal no acabó la injusticia, pero la hizo por fin jurídicamente enunciable." },
      ...
      {
        id: "nuevas-fronteras-en-los-tribunales",
